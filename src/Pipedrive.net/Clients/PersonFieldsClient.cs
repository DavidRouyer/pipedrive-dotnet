...
namespace Pipedrive
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PersonFieldsClient"/> class.
        /// </summary>
        ...
        public Task Delete(List<long> ids)
        {
            ...
            return ApiConnection.Delete(new Uri($"{ApiUrls.PersonFields()}?ids={string.Join(",", ids)}", UriKind.Relative));
        }
    }
}
